...
export default function HeroSection() {
    ...
    return (
        <section className="relative py-24 bg-gradient-to-b from-[#030820] via-[#050d2a] to-[#020617] text-white overflow-hidden">
            {/* Subtle radial glow */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,255,255,0.08),transparent_70%)] -z-10" />
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 px-6 relative z-10">
                ...
                <div className="md:w-1/2 flex justify-center items-center">
                    <div className="p-4 bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg w-full max-w-[400px] flex flex-col items-center border border-cyan-400/30">
                        ...
                        >
                            {cards.map((card, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`transition-transform duration-500 transform-style-preserve-3d aspect-square ${
                        ...
                        <button
                            onClick={resetGame}
                            className="mt-4 px-4 py-2 bg-cyan-500 rounded text-black text-sm hover:bg-cyan-400 transition"
                        >
                            Reset Game
                        </button>
                        <p className="text-center text-gray-300 mt-1 text-xs">
                            Matched: {matched.length / 2} / {cardsArray.length / 2}
                        </p>
                    </div>
                </div>
            </div>
